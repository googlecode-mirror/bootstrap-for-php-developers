...
<header class="jumbotron subhead" id="overview">
  ...
  <p class="lead">&quot;When i have an idea, I want to build the prototype as quick as posible.&quot;</p>
   <p class="lead">By Yianis Giannopoulos ... demo version for Friends and Ninjas. <a href="mailto:djazz@djazz.co.uk">contact</a></p>
    <p><? fb_like('http://www.keacode.com/boot'); ?></p>
<p>  This is a much lazy way to use bootstrat. Perfect for Developers like me who dont want to see any css and html when they make the admin panel ! Download will be available soon.
 </p>
